...
describe('Verify the useriq web dashbord is working fine', () => {
    ...
    it('Smoke:-Create a detailed two block campaign ', () => {
        ...
        //selecting Detailed two block Announcement campaigns
        simpleCampaigns.selectCampaign().eq(0).click()

        simpleCampaigns.detailedTwoBlock().should('be.visible').click()
        ...
        simpleCampaigns.selectCampaignItems().eq(0).should('not.be.disabled').click().type('DetailedTwoBlock'+randomName)
